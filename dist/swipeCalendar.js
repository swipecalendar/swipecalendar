...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".swc .swiper-container{width:100%}.swc .swiper-slide{-webkit-backface-visibility:hidden}.swc .fc-event-dragging.fc-daygrid-event{position:absolute!important;visibility:hidden}", ""]);
// Exports
module.exports = exports;
...
class swipeCalendar_SwipeCalendar {
  ...
  _init() {
    ...
    if (!this._isLicenseKeyValid(this._swipeLicenseKey)) {
  ...
  _saveCalData() {
    if (Array.isArray(this._options.events)) {
      this._calEventStore = this._curCal.currentData.eventStore;
    }

    if (Array.isArray(this._options.resources) && this._curCal.currentData.resourceStore) {
      this._calResourceStore = this._curCal.currentData.resourceStore;
    }
  }
  ...
  _isLicenseKeyValid(key) {
    ...
    if (hash(key.replace(/-/g, '')) !== 12824938) {
      return false;
    }
  ...
  _initCalendar(dateId, date) {
      ...
      eventDragStart: eventDragStart => {
        setTimeout(() => {
          if (this._curCal) {
            ...
            const draggingElements = this._curCal.el.querySelectorAll('.fc-event-dragging.fc-daygrid-event');
    ...
    if (Array.isArray(this._options.events) && this._calEventStore != null) {
      calendar.currentData.eventStore = this._calEventStore;
    }

    if (Array.isArray(this._options.resources) && this._calResourceStore != null) {
      calendar.currentData.resourceStore = this._calResourceStore;
    }
  ...
  _handleSlideChangeTransitionStart() {
    if (this._prevCal && this._nextCal) {
      if (Array.isArray(this._options.events)) {
        this._calEventStore = this._curCal.currentData.eventStore;
        this._prevCal.currentData.eventStore = this._calEventStore;
        this._nextCal.currentData.eventStore = this._calEventStore;
      ...
      if (Array.isArray(this._options.resources) && this._curCal.currentData.resourceStore) {
        this._calResourceStore = this._curCal.currentData.resourceStore;
        this._prevCal.currentData.resourceStore = this._calResourceStore;
        this._nextCal.currentData.resourceStore = this._calResourceStore;
